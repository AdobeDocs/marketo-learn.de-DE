...
Wenn Sie technischer Redakteur, Programmmanager oder Entwickler des Produktteams für ein [!UICONTROL Adobe Experience Cloud] und es Ihr Auftrag ist, technische Artikel zu erstellen oder zu diesen beizutragen, sollten Sie das private Repository unter `https://git.corp.adobe.com/AdobeDocs`.
