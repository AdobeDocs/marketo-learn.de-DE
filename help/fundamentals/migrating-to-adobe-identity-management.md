...
### &#x200B;1. Ermitteln Sie Ihre Systemadmins sowie Ihr IT-Team und besprechen Sie die Maßnahmen, die diese ggf. ergreifen müssen {#identify-your-system-administrators}
...
### &#x200B;2. Machen Sie sich mit den Änderungen und Auswirkungen einer Migration zu Adobe Identity vertraut {#familiarize-yourself-with-the-changes}
...
* [Checkliste für das Einrichten von Benutzenden](https://experienceleague.adobe.com/de/docs/marketo/using/getting-started/initial-setup/user-setup){target="_blank"}
...
* [Grundlegendes zur Verwendung der Adobe Admin Console](https://helpx.adobe.com/de/enterprise/using/admin-console.html){target="_blank"}

### &#x200B;3. Informieren Sie Ihre internen Teams über den Zeitplan und die erforderliche Vorbereitung für die Migration {#announce-the-migration-timeline}
...
i. Sie haben eine E-Mail mit einer Anfrage zur E-Mail-Bestätigung erhalten, die einen Link enthält (bleibt 3 Tage gültig). Wenn Ihr Link abgelaufen ist, können Sie die Bestätigungs-E-Mail in Marketo Engage erneut senden, indem Sie auf das Symbol „Mein Profil“ klicken und dann zu **Mein Konto** > **Kontoeinstellungen** > **Bestätigung erneut senden** navigieren.
