...
+ [Tutorials zu [!DNL Marketo Engage]](/help/_marketo-main/overview.md)
+ Grundlagen {#fundamentals}
   ...
   + [Käufer-Personas](/help/fundamentals/buyer-personas-learn.md)
   ...
   + [Token – Überblick](/help/fundamentals/tokens-overview.md)
   ...
   + [Migrieren zu Adobe Identity Management](/help/fundamentals/migrating-to-adobe-identity-management.md)
   + [Best Practices für das Organisieren einer neuen Instanz](/help/fundamentals/best-practices-to-organize-a-new-instance.md)
   + [Best Practices für das Erstellen grundlegender Programme](/help/fundamentals/best-practices-for-creating-foundational-programs.md)
   + [Implementieren einer neuen Instanz – Tutorial](https://experienceleague.adobe.com/de/docs/experiences-by-you/implementing-new-instance/overview)
   + [Prüfen einer übernommenen Instanz – Tutorial](https://experienceleague.adobe.com/docs/marketo-learn/auditing-an-inherited-instance/overview.html?lang=de)
+ Programme und Kampagnen {#programs-and-campaigns}
   ...
   + [Grundlagen zu intelligenten Kampagnen](/help/campaigns/smart-campaigns-101.md)
   + [Einführung in Kanäle, Tags und Zeitraumkosten](/help/programs/channels-tags-period-costs.md)
   + [Ereignisprogramme](/help/programs/event-programs.md)
   ...
   + E-Mail-Programme {#email-programs}
      ...
      + [Definieren Ihrer Zielgruppe](/help/programs/email-programs/define-your-audience.md)
      + [Erstellen einer Landingpage](/help/programs/email-programs/create-a-landing-page.md)
      + [Erstellen eines Formulars](/help/programs/email-programs/create-a-form.md)
   + Interaktionskarten {#engagement-maps}
      + [Interaktionskarte – Überblick](/help/engagement-maps/engagement-map-overview.md)
      + [Verschachtelte Kampagnen mithilfe einer Interaktionskarte](/help/engagement-maps/engagement-map-nested-campaign.md)
      + [Fehlererkennung und -behebung mithilfe einer Interaktionskarte](/help/engagement-maps/engagement-map-error-detection-and-resolution.md)
+ E-Mail-Marketing {#email-marketing}
   + [Geplante E-Mail](/help/email-marketing/scheduled-email-learn.md)
   + [Anleitung zu geplanten E-Mails](/help/email-marketing/scheduled-email-watch.md)
   ...
   + [Anleitung für Gated-Content-Angebot](/help/email-marketing/gated-content-offer-watch.md)
   + [A/B-Tests](/help/email-marketing/ab-testing-learn.md)
   + [Anleitung zu A/B-Tests](/help/email-marketing/ab-testing-watch.md)
   ...
   + [Anleitung zur Zustellbarkeit von E-Mails](/help/email-marketing/email-deliverability-watch.md)
   + [Ausgelöste E-Mail](/help/email-marketing/triggered-email-learn.md)
   + [Anleitung zu ausgelösten E-Mails](/help/email-marketing/triggered-email-watch.md)
...
+ Cross-Channel-Marketing {#cross-channel-marketing}
   + [Anleitung zu Formularen](/help/email-marketing/forms-watch.md)
   + [Integrieren von Mobil-Marketing](/help/cross-channel-marketing/mobile-marketing-learn.md)
   + [Anleitung zu Mobil-Marketing](/help/cross-channel-marketing/mobile-marketing-watch.md)
...
+ Dynamic Chat {#dynamic-chat}
   ...
   + [Go-Live in 15 Minuten](/help/dynamic-chat/go-live-in-15-minutes.md)
   ...
   + [Agent-Verwaltung](/help/dynamic-chat/agent-management.md)
   + [Dialog-Verwaltung](/help/dynamic-chat/dialogue-management.md)
   ...
   + [Konversations-Landingpages](/help/dynamic-chat/conversational-landing-pages.md)
   + [Best Practices zur Live-Chat-Implementierung](/help/dynamic-chat/live-chat-best-practices.md)
   + [Verbinden von Besucherinnen und Besuchern mit Live-Agentinnen und -Agenten](/help/dynamic-chat/connect-visitors-to-live-agents.md)
   + [Meeting-Buchungen](/help/dynamic-chat/meeting-booking.md)
...
+ Sales Insight-Aktionen {#sales-insight-actions}
   ...
   + [Sales Insight-Aktionen – Überblick](/help/sales-insight-actions/sales-insight-actions-overview.md)
   + [Zugreifen auf Ihre Sales Insight-Aktionsinstanz](/help/sales-insight-actions/accessing-your-sales-insight-actions-instance.md)
   + [Konfigurieren der Protokollierung von Verkaufsaktivitäten für [!DNL Salesforce]](/help/sales-insight-actions/configure-sales-activity-logging-to-salesforce.md)
+ Lead- und Daten-Management {#lead-and-data-management}
   ...
   + [Bewertung von Leads/Personen](/help/lead-and-data-management/lead-scoring-learn.md)
   + [Anleitung zum Bewerten von Leads/Personen](/help/lead-and-data-management/lead-scoring-watch.md)
   + [Informationen zum Lead-Lebenszyklus](/help/lead-and-data-management/understanding-the-lead-lifecycle.md)
   + [Abonnement-Center](/help/lead-and-data-management/subscription-center-learn.md)
   + [Anleitung zum Abonnement-Center](/help/lead-and-data-management/subscription-center-watch.md)
   + [CRM-Synchronisierung](/help/lead-and-data-management/crm-sync-learn.md)
   + [Erste Schritte bei der Salesforce-Synchronisierung](/help/integrations/salesforce-sync-setup.md)
   + [Erste Schritte bei der Microsoft Dynamics-Synchronisierung](/help/integrations/microsoft-dynamics-sync-setup.md)
...
+ Ereignisse {#events}
   + [Anleitung zu Ereignissen](/help/events/events-watch.md)
   + [Erstellen eines Ereignisprogramms](/help/events/events-learn.md)
   + [Webinare](/help/events/webinar-learn.md)
   + [Anleitung zu Webinaren](/help/events/webinar-watch.md)
   + [Interaktive Webinare – Überblick](/help/events/interactive-webinars-overview.md)
   + [Interaktive Webinare – Benutzer- und Lizenzverwaltung](/help/events/interactive-webinars-user-and-license-management.md)
   + [Interaktive Webinare – Erstellung eines Ereignisprogramms](/help/events/interactive-webinars-event-program-creation.md)
   + [Interaktive Webinare – Überblick über Ereignisprogramme](/help/events/interactive-webinars-event-program-overview.md)
   + [Interaktive Webinare – Ereigniskonfiguration](/help/events/interactive-webinars-event-configuration.md)
   + [Gestalten von effektiven interaktiven Webinaren](/help/events/design-an-effective-interactive-webinar.md)
   + [Interaktive Webinare – Ereignisbereitstellung](/help/events/interactive-webinars-event-delivery.md)
   + [Interaktive Webinare – Erkenntnisse und Aktionen nach dem Ereignis](/help/events/interactive-webinars-post-event-insights-and-actions.md)
...
+ Integrationen {#integrations}
   ...
   + [API-Hilfe – Festlegen des Zugriffs-Tokens in einer Variablen](/help/integrations/api-set-access-token-variable.md)
   + [Auslösen einer intelligenten Kampagne in Marketo Engage mithilfe der REST-API und Token](/help/integrations/trigger-smart-campaign-rest-api.md)
+ Verwalten von Duplikaten {#manage-duplicates}
   ...
   + [Verstehen, wie es zu Duplikaten kommen kann](/help/managing-duplicates/why-duplicates-occur.md)
   + [Identifizieren und Verhindern von doppelten Einträgen](/help/managing-duplicates/identify-prevent-duplicates.md)
   + [Ermitteln, wann doppelte Einträge erforderlich sind](/help/managing-duplicates/determine-necessary-duplicates.md)
   ...
   + [Vereinfachen der Duplikatverwaltung](/help/managing-duplicates/simplify-acs.md)
   + [Auswählen der besten Strategie zum Verwalten von Duplikaten](/help/managing-duplicates/duplicate-strategy.md)
